...
name: code-review
description: |
  Provides comprehensive code review guidance for Java applications.
  Helps catch bugs, improve code quality, and give constructive feedback.
  Use when: reviewing pull requests, conducting PR reviews, code review, reviewing code changes,
  establishing review standards, mentoring developers, architecture reviews, security audits,
  checking code quality, finding bugs, giving feedback on code, reviewing Java code,
  Spring Boot review, JPA review, Java best practices.
allowed-tools:
  - Read
  - Grep
  - Glob
...
For Java code reviews, consult the detailed guide:

| Language/Framework | Reference File | Key Topics |
|-------------------|----------------|------------|
| **Java** | [Java Guide](reference/java.md) | Java 17/21 features, Spring Boot 3, Virtual Threads, Stream/Optional, JPA |
